            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-6" data-aos="fade-up">
                        ...
                        <div className="resume-item">
                            <h4>African Business Education (ABE) Initiative Master&apos;s Degree and Internship Program
                                2017.</h4>
                        ...
                        <div className="resume-item">
                            <h4>The Impact of Sentiment Analysis on Social Media to Assess Customer Satisfaction: The
                                Case of Rwanda.</h4>
                            <h5>March 2019</h5>
                            <p><em>2019 IEEE 4th International Conference on Big Data Analytics (ICBDA), Suzhou,
                                China</em></p>
                            <p>pp. 356-359. DOI: <a
                                href="https://doi.org/10.1109/ICBDA.2019.8713212">10.1109/ICBDA.2019.871321</a></p>
                        </div>
                    ...
                    <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div className="resume-item">
                            ...
                            <p>As a member of The Room&apos;s Global Tech Expert, I had the opportunity to mentor
                                Africa&apos;s
                        ...
                        <div className="resume-item">
                            ...
                            <ul>
                                ...
                                <li>Pair programming for knowledge sharing on real-world projects.</li>
                            </ul>
                        </div>
                        <div className="resume-item">
                            <h4>Software Engineer Contract</h4>
                            <h5>September 2020 – June 2023</h5>
                        ...
                        <div className="resume-item">
                            ...
                            <ul>
                                ...
                                <li>Used development tools such as Yii Framework, Arduino, and React Native on regular
                                    basis.
                                </li>
                        ...
                        <div className="resume-item">
                            ...
                            <h5>October 2015 – August 2017</h5>
                            <p><em>Algorithm Inc., Kigali, Rwanda</em></p>
                            <p>My primary responsibility was collecting user feedback and designing better features to
                                improve user experience and customer satisfaction.</p>
                            <ul>
